...
\section{One side: Homotopy Theory}
\subsection{To invert weak equivalences}
...
\subsection{Extending functors over localization}
...
\subsection{``Weak equivalences are all that matter''}
...
\section{The other: Category Theory}
